/datum/map/torch
	...
	station_name  = "NDV Immortal"
	station_short = "Immortal"
	dock_name     = "TBD"
...
/datum/map/torch/map_info(victim)
	...
	to_chat(victim, "You're aboard the <b>[station_name]</b>, a Nanotrasen vessel. Its primary mission is to explore the Azhura-Mazda system.")
	to_chat(victim, "The vessel is staffed with a mix of NT personnel and hired contractors.")
	to_chat(victim, "This area of space has only been preliminarily surveyed. You might encounter remote outposts or drifting hulks, but no recognized government holds claim on this system.")

/datum/map/torch/send_welcome()
	var/welcome_text = "<center><img src = sollogo.png /><br /><font size = 3><b>NDV Immortal</b> Sensor Readings:</font><br>"
	...
	welcome_text += "Travel time to Sol:<br /><b>[rand(150,365)] days</b><br /><br>"
	welcome_text += "Time since last port visit:<br /><b>[rand(60,200)] days</b><br /><hr>"
	...
	post_comm_message("NDV Immortal Sensor Readings", welcome_text)
