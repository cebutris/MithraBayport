...
/datum/job/liaison/get_description_blurb()
	return "You are the Workplace Liaison. You are a civilian employee of NanoTrasen, assigned to the vessel to promote corporate interests and protect the rights of the contractors on board. You are not internal affairs. You assume command of the Research Department in the absence of the RD and the Senior Researcher. You advise the RD on corporate matters and try to push corporate interests on the CO, and speak for the workers where required. Maximise profit. Be the shady corporate shill you always wanted to be."
...
/datum/job/bodyguard/get_description_blurb()
	return "You are the Loss Prevention Associate. You are an employee of NanoTrasen, and your job is to prevent the loss of the Liason's life - even at the cost of your own. Good luck."
