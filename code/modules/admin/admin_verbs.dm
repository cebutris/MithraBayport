...
/client/proc/editappear()
	...
	if(!istype(M, /mob/living/carbon/human))
		...
		return
	switch(alert("Are you sure you wish to edit this mob's appearance? Skrell, Unathi, Vox and Tajaran can result in unintended consequences.",,"Yes","No")) // Adding back Tajara. - HTG
		if("No")
			return
	...
	var/new_skin = input("Please select body color. This is for Tajaran, Unathi, and Skrell only!", "Character Generation") as color // Adding back Tajara. - HTG
	if(new_skin)
