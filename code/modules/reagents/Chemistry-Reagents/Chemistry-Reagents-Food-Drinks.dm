...
/datum/reagent/drink/coffee/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed) // Adding back Tajara. - HTG
	if(alien == IS_DIONA)
		return
	..()
	if(alien == IS_TAJARA)
...
/datum/reagent/nutriment/coffee/affect_blood(var/mob/living/carbon/M, var/alien, var/removed) // Adding back Tajara. - HTG
	..()
	if(alien == IS_TAJARA)
		M.adjustToxLoss(2 * removed)
		M.make_jittery(4)
...
/datum/reagent/drink/coffee/overdose(var/mob/living/carbon/M, var/alien) // Adding back Tajara. - HTG
	if(alien == IS_DIONA)
		return
	if(alien == IS_TAJARA)
...
/datum/reagent/ethanol/coffee/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed) // Adding back Tajara. - HTG
	if(alien == IS_DIONA)
		return
	..()
...
/datum/reagent/ethanol/coffee/affect_blood(var/mob/living/carbon/M, var/alien, var/removed) // Adding back Tajara. - HTG
	if(alien == IS_TAJARA)
		M.adjustToxLoss(2 * removed)
		M.make_jittery(4)
		return
...
/datum/reagent/ethanol/coffee/overdose(var/mob/living/carbon/M, var/alien) // Adding back Tajara. - HTG
	if(alien == IS_DIONA)
		return
	if(alien == IS_TAJARA)
		M.adjustToxLoss(4 * REM)
